...
opemwebui-run-pi:
    docker run -d --rm -p 3000:8080 -e OLLAMA_BASE_URL=http://rasp-ollama.ht.home:11434 -v open-webui:/app/backend/data --name open-webui ghcr.io/open-webui/open-webui:main
    sleep 1
    open http://localhost:3000
